      ...
      >
        <Stack gap={4}>
          ...
          <Typography variant="h6">
            ...
            доступ до сучасних моделей реплік відомих брендів, таких як Найк,
            Адідас та Пума. У нас ви знайдете широкий вибір взуття, що
            відповідає останнім трендам і вимогам якості. Приєднуйтесь до нашої
            спільноти любителів футболу та знайдіть ідеальну пару футбольного
            взуття для своїх спортивних досягнень та стилю!
          </Typography>
        </Stack>
        <Box
          component="img"
